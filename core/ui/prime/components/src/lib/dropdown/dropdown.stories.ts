...
Editable.play = async (context) => {
  userEvent.click(
    context.canvasElement.getElementsByClassName('p-dropdown-trigger')[0]
  );
  userEvent.click(
    context.canvasElement.getElementsByClassName('p-dropdown-item')[1]
  );
  userEvent.click(
    context.canvasElement.getElementsByClassName('p-dropdown-label')[0]
  );
  userEvent.type(
    context.canvasElement.getElementsByClassName('p-dropdown-label')[0],
    '{backspace}'.repeat(6)
  ...
  await expect(
    ...
    (
      context.canvasElement.getElementsByClassName(
        'p-dropdown-label'
